...
var question6=function(filePath){
    ...
    csv.then(function (data) {
        ...
        svg.append("text")
            ...
            .attr("y", height )
            .attr("dy", "2.5em")
            .text("Time").attr("font-family", "sans-serif").attr("font-size", "13px").attr("font-weight", "bold").attr("fill", "black");
        ...
        svg.append("text")
            ...
            .attr("dx", "1em")
            .attr("transform", "rotate(-90)")
            .text("Number of Accidents Per Month").attr("font-family", "sans-serif").attr("font-size", "13px").attr("font-weight", "bold").attr("fill", "black");
