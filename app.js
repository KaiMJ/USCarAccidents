function assignment2() {
    ...
    // question4(filePath);
    // question5(filePath);
    // question6("smallCleanedData.csv");
    // question7(filePath);
}
    ...
    data.then(function (data) {
        ...
        var data = data.map(function (d) {
            return {
                ...
                ), //parseInt(d.Start_Time.match(/(?<![\d]{4}-)-(\d\d)(?=[-\d])/)[0].replace('-', '')),//parseInt(d.Start_Time.match(/(?<![\d]{4}[-][\d]{2}[-]\d]{2}) \d\d/)[0]),
        ...
        let fm = [...rollup].flatMap(([k1, v1]) =>
            [...v1].map(([k2, v2]) => ({ Year: k1, Hour: k2, Count: v2 }))
        );
        ...
        medals = medals.sort(function (a, b) {
        ...
        var x = d3.scaleBand().range([0, width]).domain(hour).padding(0.05);
        ...
        var y = d3.scaleBand().range([height, 0]).domain(years).padding(0.05);
        ...
        svg.selectAll()
            ...
            .on("mouseover", function (event, d) {
                ...
                Tooltip.html(d.val.toLocaleString("en-US"))
        ...
        svg.append("text")
            ...
            .text(
                "Heatmap of Total Number of Accidents Per Year and Hour of The Day"
            )
            .attr("font-family", "sans-serif")
            .attr("font-size", "15px")
            .attr("font-weight", "bold")
...
var question2 = function (filePath) {
    ...
    data.then(function (data) {
        ...
        let fm = [...rollup].flatMap(([k1, v1]) =>
            [...v1].map(([k2, v2]) => ({ Year: k1, Month: k2, Count: v2 }))
        );
        let fm2 = fm.sort(function (a, b) {
    ...
    data.then(function (data) {
        ...
        var getBars = function (data, str) {
            ...
            d3.select("#q3_title")
                ...
                .style("text-decoration", "underline")
                .style("font-weight", "bold")
                .text("Total Number of Accidents Per Month/Year/Hour of Day")
                .attr("font-family", "sans-serif")
                .attr("font-size", "15px")
                .attr("font-weight", "bold")
                .attr("fill", "black");
...
var question4 = function (filePath) {
    ...
    data.then(function (data) {
        ...
        svg.append("text")
            ...
            .style("text-decoration", "underline")
            .text(
                "Scatterplot of Temperature vs Humidity for The Most Severe Accidents"
            )
            .attr("font-family", "sans-serif")
            .attr("font-size", "15px")
            .attr("font-weight", "bold")
...
var question5 = function (filePath) {
    ...
    data.then(function (data) {
        ...
        svg.append("text")
            ...
            .style("font-size", "16px")
            .style("text-decoration", "underline")
            .text("Boxplots for Temperature for Each Severness Category")
            .attr("font-family", "sans-serif")
            .attr("font-size", "15px")
            .attr("font-weight", "bold")
            .attr("fill", "black");
...
var question6 = function (filePath) {
    ...
    d3.select("#q6_title")
        ...
        .style("font-weight", "bold")
        .text(
            "Streamgraph for Total Number of Accidents Per States in U.S. Region"
        )
        .attr("font-family", "sans-serif")
        .attr("font-size", "15px")
        .attr("font-weight", "bold")
...
var question7 = function (filePath) {
    ...
    csv.then(function (data) {
        ...
        console.log(bs);
        const output = Array.from(bs).map(([State, Count]) => ({
            State,
            Count,
        }));
        console.log(output);
